...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[#0B111E] text-[#E2E8F0] p-4 sm:p-6 selection:bg-gold/20 selection:text-gold animate-fade-in">
